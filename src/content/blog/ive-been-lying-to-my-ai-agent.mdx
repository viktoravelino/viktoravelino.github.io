...
<ArticleCard
  ...
  description="A study from ETH Zurich finds that developer-written context files can actually decrease coding agent performance by 20% and increase costs by 20%."
  source="arxiv.org"
/>

<ArticleCard
  url="https://snyk.io/blog/toxicskills-malicious-ai-agent-skills-clawhub"
  title="ToxicSkills Study Finds 36% of AI Agent Skills Vulnerable to Prompt Injection"
  description="Snyk Finds Prompt Injection in 36%, 1467 Malicious Payloads in a ToxicSkills Study of Agent Skills Supply Chain Compromise"
  source="snyk.io"
/>
